...
const Body = () => {
  ...
  return !allResturants.length ? (
    ...
    <div className="px-20">
      <div className="text-center search-container mb-14">
        <input
          type="text"
          className="p-2 px-20 border-2 border-purple-300 rounded-md mr-4"
        ...
        />
        <button
          className="bg-purple-400 p-2 px-6 rounded-lg text-white"
          onClick={(e) => {
